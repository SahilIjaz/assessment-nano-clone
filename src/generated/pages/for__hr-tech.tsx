/* generated from for__hr-tech.html */
import SiteNav from "@/components/site/SiteNav";
import SiteFooter from "@/components/site/SiteFooter";

export default function P_for__hr_tech() {
  return (
    <>
      <div hidden>
      </div>
          ...
          <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6">
            ...
            <div className="max-w-[840px]">
              ...
              <h1 className="text-[clamp(32px,5vw,54px)] font-light leading-[1.06] tracking-[-0.025em] mb-7">
                LinkedIn creator marketing for HR-tech
              </h1>
        ...
        <div className="px-4 sm:px-6 pt-12 sm:pt-16 pb-24">
          <div className="max-w-[840px] mx-auto">
            <div className="text-[17px] text-[#1F2937] leading-[1.75]">
              ...
              <p className="my-5">
                People Ops leads, heads of talent, and HR consultants with 2k–7k followers posting about hiring, retention, comp, and people analytics — audiences of HR decision-makers and their influencers.
              </p>
              <p className="my-5">
              ...
              <div className="my-8 space-y-8">
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    What does an HR-tech creator campaign cost?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    Fixed pricing from €20/post. Q1 2026 median CPL was €20 across 34 campaigns — slightly above the platform mean, reflecting thinner creator supply and a wider buying committee.
                  </p>
                </div>
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    Is HR-tech creator supply sufficient?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    The pool is thinner than sales or RevOps but growing; most briefs match in one pass. Naano flags upfront when a niche brief (e.g. comp-specific) needs a wider matching window.
                  </p>
                </div>
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    Do HR audiences convert on creator posts?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    Yes — HR professionals are among the most active LinkedIn audiences, and a recommendation from a People Ops voice they follow carries more weight than an ad in a category with high software fatigue.
                  </p>
                </div>
              </div>
              <h2 className="text-[clamp(22px,2.6vw,30px)] font-light tracking-[-0.02em] text-[#111827] mt-16 mb-5 pt-4 border-t border-[#F3F4F6]">

/* generated from for__sales-tech.html */
import SiteNav from "@/components/site/SiteNav";
import SiteFooter from "@/components/site/SiteFooter";

export default function P_for__sales_tech() {
  return (
    <>
      <div hidden>
      </div>
          ...
          <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6">
            ...
            <div className="max-w-[840px]">
              ...
              <h1 className="text-[clamp(32px,5vw,54px)] font-light leading-[1.06] tracking-[-0.025em] mb-7">
                LinkedIn creator marketing for sales-tech SaaS
              </h1>
          ...
          <div className="max-w-[840px] mx-auto">
            <div className="text-[17px] text-[#1F2937] leading-[1.75]">
              ...
              <p className="my-5 text-sm text-[#6B7280]">
                ...
                Sales-tech
                {" campaigns ("}
                https://naano.com/for/sales-tech
                ).
              </p>
              ...
              <p className="my-5">
                SDR managers and coaches posting about cold outbound, AEs sharing discovery and closing frameworks, RevOps-adjacent sales leaders — typically 2k–8k followers with 70–90% sales-practitioner audiences.
              </p>
              <p className="my-5">
              ...
              <div className="my-8 space-y-8">
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    What does a sales-tech creator campaign cost on Naano?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    Posts are booked at a fixed price from €20 per post (median creator ~€150). In Q1 2026, sales-tech campaigns delivered a median cost per qualified click of €16 across 58 campaigns — the second-cheapest vertical on the platform.
                  </p>
                </div>
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    Which creators cover sales-tech?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    SDR coaches, AE practitioners, and sales leaders with 2k–8k LinkedIn followers, vetted for audience fit. Their followers are predominantly quota-carrying sales professionals — the buying users of sales-tech products.
                  </p>
                </div>
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    How fast can a sales-tech campaign launch?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    Median time from brief to first live post is 7 days across the platform. Sales-tech is usually faster than average because the creator pool is deep enough to match most briefs in one pass.
                  </p>
                </div>
              </div>
              <h2 className="text-[clamp(22px,2.6vw,30px)] font-light tracking-[-0.02em] text-[#111827] mt-16 mb-5 pt-4 border-t border-[#F3F4F6]">

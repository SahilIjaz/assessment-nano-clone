/* generated from for__vertical-saas.html */
import SiteNav from "@/components/site/SiteNav";
import SiteFooter from "@/components/site/SiteFooter";

export default function P_for__vertical_saas() {
  return (
    <>
      <div hidden>
      </div>
        ...
        <div className="px-4 sm:px-6 pt-12 sm:pt-16 pb-24">
          <div className="max-w-[840px] mx-auto">
            <div className="text-[17px] text-[#1F2937] leading-[1.75]">
              ...
              <p className="my-5">
                Vertical SaaS is the most expensive cluster on the platform (~15% above the mean): creator supply is sparse by definition, so creator pricing rises. The offset is audience fit — a niche-industry creator's audience is almost entirely your ICP.
              </p>
              <p className="my-5 text-sm text-[#6B7280]">
                ...
                Vertical SaaS
                {" campaigns ("}
                https://naano.com/for/vertical-saas
                ).
              </p>
              ...
              <p className="my-5">
                Industry practitioners who publish: a construction PM posting about site software, a paralegal covering legal-tech, an insurance broker reviewing tooling — small followings (1k–5k) with near-total ICP overlap.
              </p>
              <p className="my-5">
              ...
              <div className="my-8 space-y-8">
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    Are there creators for my specific niche industry?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    Supply is checked before you commit: Naano verifies matching creators for your niche at brief time and tells you upfront if the pool is thin. Vertical SaaS briefs sometimes take a wider matching window than horizontal categories.
                  </p>
                </div>
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    Why is vertical SaaS CPL higher?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    Scarce creator supply raises per-post pricing — Q1 2026 median CPL was €21 across 28 campaigns, ~15% above the platform mean. The compensation is audience fit: near-total ICP overlap versus single-digit relevance on broad channels.
                  </p>
                </div>
                <div>
                  <h3 className="text-[clamp(18px,2vw,22px)] font-medium tracking-[-0.01em] text-[#111827] mb-3">
                    Is a small niche audience worth a campaign?
                  </h3>
                  <p className="text-[#374151] leading-[1.7]">
                    In vertical SaaS, yes: a creator with 2,000 followers who are all in your industry out-delivers a 100k generalist. The qualified-click math favors precision over reach — the same logic covered in our nano vs macro creators data.
                  </p>
                </div>
              </div>
              <h2 className="text-[clamp(22px,2.6vw,30px)] font-light tracking-[-0.02em] text-[#111827] mt-16 mb-5 pt-4 border-t border-[#F3F4F6]">
              ...
              <div className="my-6 flex flex-wrap gap-2">
                ...
                <a className="text-sm px-3.5 py-1.5 rounded-full border border-[#E5E7EB] text-[#374151] hover:border-[#9CA3AF] hover:text-[#111827] transition-colors duration-150 motion-reduce:transition-none focus:outline-none focus-visible:ring-2 focus-visible:ring-[#111827] focus-visible:ring-offset-2" href="/for/devtools">
                  Devtools
                </a>
